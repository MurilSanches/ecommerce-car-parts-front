...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: '/fornecedor', lazy: () => import('./pages/supplier/Dashboard').then(m => ({ Component: m.default })) },
      { path: '/fornecedor/produtos', lazy: () => import('./pages/supplier/ProductsList').then(m => ({ Component: m.default })) },
      { path: '/fornecedor/produtos/novo', lazy: () => import('./pages/supplier/ProductCreate').then(m => ({ Component: m.default })) },
      { path: '/fornecedor/produtos/editar/:id', lazy: () => import('./pages/supplier/ProductEdit').then(m => ({ Component: m.default })) },
      { path: '/fornecedor/perfil', lazy: () => import('./pages/supplier/SupplierProfile').then(m => ({ Component: m.default })) },
      { path: '/quem-somos', lazy: () => import('./pages/static/About').then(m => ({ Component: m.default })) },
      { path: '/politica-privacidade', lazy: () => import('./pages/static/Privacy').then(m => ({ Component: m.default })) },
      { path: '/termos-de-uso', lazy: () => import('./pages/static/Terms').then(m => ({ Component: m.default })) },
      { path: '/central-de-ajuda', lazy: () => import('./pages/static/Help').then(m => ({ Component: m.default })) },
